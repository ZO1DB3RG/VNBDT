...
if __name__ == '__main__':
    ...
    #获取网络
    net = calling_VGG_from_tar(args.model_path)
    #生成树并读取
    ...
    type_name = os.path.split(path_img)[1].split('.')[0] + '_' + args.cam_method + '_' + args.arch + '_' + 'FG-4'
    ...
    target_layers = [model.model.conv6] #模型哪一个layer
    x = x.cuda()
    ...
    decisions_prob = fuse_leaf_cam_from_method(decisions[0],img2,type_name,
